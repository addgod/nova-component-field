...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-component-field', __webpack_require__(4));
    Vue.component('detail-component-field', __webpack_require__(7));
    Vue.component('form-component-field', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        ...
        _.each(this.components, function (component) {
            __WEBPACK_IMPORTED_MODULE_1_vue___default.a.set(_this.content, component.attribute, []);
        });
        ...
        _.each(this.fields, function (field) {
            field.value = _this.field.value ? _this.field.value[field.attribute] : null;
        });
    },
    ...
    methods: {
        ...
        fill: function fill(formData) {
            ...
            _.each(this.fields, function (field) {
                field.attribute = _this2.field.attribute + '[' + field.attribute + ']';
                field.fill(formData);
            });
            _.each(this.content, function (sections, attribute) {
                _.each(sections, function (block, index) {
                    block.attribute = _this2.field.attribute + '[' + attribute + '][' + index + ']';
                    block.fill(formData);
    ...
    computed: {
        ...
        fields: function fields() {
            ...
            return this.field.fields.filter(function (field) {
                return field.component !== _this4.field.component;
            });
        },
