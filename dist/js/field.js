...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-component-field', __webpack_require__(3));
    Vue.component('detail-component-field', __webpack_require__(6));
    Vue.component('form-component-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        if (this.field.value) {
            _.each(this.field.value, function (value, key) {
                var field = _.cloneDeep(_this.field.fields.find(function (field) {
                    return field.attribute === key;
                }));
                if (field.component === _this.field.component) {
                    _.each(value, function (val) {
                        field.value = val.valueOf();
                    });
                } else {
                    field.value = _this.parseString(value);
                }
                _this.addComponent(field);
            });
        } else {
    ...
    methods: {
        ...
        fill: function fill(formData) {
            ...
            _.each(this.fields, function (field) {
                if (field.component === _this2.field.component) {
                    var index = _this2.fields.filter(function (f) {
                        return f.attribute === field.attribute;
                    }).indexOf(field);
                    field.attribute = _this2.field.attribute + '[' + field.attribute + '][' + index + ']';
                } else {
