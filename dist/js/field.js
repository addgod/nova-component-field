...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-component-field', __webpack_require__(13));
    Vue.component('detail-component-field', __webpack_require__(16));
    Vue.component('form-component-field', __webpack_require__(19));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        this.field.value = JSON.stringify(this.field.value, null, 2);
        this.field.options = { 'mode': 'application/json' };
    }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("detail-code-field", {
    tag: "component",
    attrs: { "resource-name": _vm.field.resourceName, field: _vm.field }
  })
}
var staticRenderFns = []
render._withStripped = true
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_form_backend_validation__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        ...
        _.each(this.components, function (component) {
            __WEBPACK_IMPORTED_MODULE_2_vue___default.a.set(_this.content, component.attribute, []);
        });

        _.each(this.field.value, function (value, attribute) {
            if (_this.content.hasOwnProperty(attribute)) {
                _.each(value, function (block) {
                    var component = _this.components.find(function (component) {
                        return component.intl_slug === block.component;
                    });
                    _this.addBlock(component, block);
                });
            }
        });
        ...
        _.each(this.fields, function (field) {
            ...
            field.attribute = _this.field.attribute + '[' + attribute + ']';
            field.value = _this.field.value ? _this.field.value[attribute] : null;
        });
    },
    ...
    methods: {
        ...
        fill: function fill(formData) {
            ...
            _.each(this.content, function (sections) {
                _.each(sections, function (block) {
                    block.fill(formData);
        ...
        removeBlock: function removeBlock(attribute, index) {
    ...
    computed: {
        components: function components() {
            ...
            return this.field.fields.filter(function (field) {
                return field.component === _this2.field.component;
            });
        },
        fields: function fields() {
            ...
            return this.field.fields.filter(function (field) {
                return field.component !== _this3.field.component;
            });
        },
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function withOptions(options) {
            ...
            this.__http = options.http || windowAxios || __webpack_require__(28);
...
var _objects = __webpack_require__(25);
...
var _formData = __webpack_require__(26);
...
var _fieldNameValidation = __webpack_require__(27);
...
var render = function() {
  ...
  return _c("div", { staticClass: "m-3" }, [
    _c(
      "div",
      { staticClass: "card overflow-hidden border border-60" },
      [
        _c("div", { staticClass: "border-b border-60 bg-40 p-4 mb-2" }, [
          _c("div", { staticClass: "flex" }, [
            _c("h4", { staticClass: "flex-1" }, [
              _vm._v(_vm._s(_vm.field.indexName))
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "flex-1 text-right" }, [
              _vm.index > -1
                ? _c(
                    ...
                    {
                      staticClass:
                        "float-right hover:bg-grey-lightest text-grey-darkest font-semibold",
                      attrs: { type: "button" },
                      on: {
        ...
        _c(
          "div",
          { staticClass: "flex", class: _vm.outerClass },
        ...
        _vm._v(" "),
        _vm._l(_vm.content, function(sections, attribute) {
          return _c(
            "div",
            ...
            [
              _c("div", { staticClass: "px-4" }, [
                _c(
                  ...
                  [_vm._v(_vm._s(_vm._f("capitalize")(attribute)))]
                )
              ]),
              _vm._v(" "),
              _vm._l(sections, function(block, index) {
                return _c("form-" + block.component, {
                  key: index,
                  tag: "component",
                  attrs: {
                    errors: _vm.sanitizedErrors,
                  ...
                  on: {
                    remove: function($event) {
                      _vm.removeBlock(attribute, index)
                    }
                  }
                })
              })
